...
import com.nanioi.todolist.databinding.ActivityDetailBinding
import com.nanioi.todolist.presentation.BaseActivity
...
internal class DetailActivity : BaseActivity<DetailViewModel>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setResult(Activity.RESULT_OK) // ok값을 받아다가 매번 refresh를 해주기 위해
    }
